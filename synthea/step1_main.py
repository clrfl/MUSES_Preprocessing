...
SYNTHEA_SIMULATION_DATE = "2026-03-19 14:00"
SYNTHEA_SIMULATION_DATE_TS = dt.datetime.strptime(
    "2026-03-19 14:00", r"%Y-%m-%d %H:%M")
...
if __name__ == '__main__':
    ...
    main(
        seed=43,#parsed_args.seed,
        ratio_train=1,#parsed_args.ratio_train,
        ratio_val=1,#parsed_args.ratio_val,
        synthea_path="/home/user/synthea/output/FULL/csv/",#parsed_args.synthea_path,
        save_path="/home/user/synthea/output/FULL/preproc/")#parsed_args.save_path)